...
customer_loss_model.load_model("/Users/quantum/PycharmProjects/EasyManDM/17112009customer_loss_train")
...
for train_data in generator:
    ...
    if sum(predict_result) > 0:
        predict_dead_user_precise = 1.0*sum([1 if true_result[i] == 1 and predict_result[i] == 1 else 0
